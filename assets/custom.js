...
!function (e, t) {
  ...
  var oe = [],
    ...
    var e,
      ...
      var i,
        ...
        if (11 !== p && (u = L.exec(t))) if (i = u[1]) {
          ...
          if (c = t, f = e, 1 === p && (x.test(t) || m.test(t))) {
            (f = H.test(t) && z(e.parentNode) || e) == e && le.scope || ((s = e.getAttribute("id")) ? s = ce.escapeSelector(s) : e.setAttribute("id", s = S)), o = (l = Y(t)).length;while (o--) {
              l[o] = (s ? "#" + s : ":scope") + " " + Q(l[o]);
            }c = l.join(",");
          }try {
      ...
      var t,
          n = e ? e.ownerDocument || e : ye;return n != T && 9 === n.nodeType && n.documentElement && (r = (T = n).documentElement, C = !ce.isXMLDoc(T), i = r.matches || r.webkitMatchesSelector || r.msMatchesSelector, ye != T && (t = T.defaultView) && t.top !== t && t.addEventListener("unload", R), le.getById = $(function (e) {
      ...
      return this.pushStack(ce.uniqueSort(ae.apply(this)));
        ...
        }, enabled: X(!1), disabled: X(!0), checked: function checked(e) {
    ...
    } }), ce.ready.then = O.then, "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? ie.setTimeout(ce.ready) : (C.addEventListener("DOMContentLoaded", P), ie.addEventListener("load", P));var R = function R(e, t, n, r, i, o, a) {
    var s = 0,
        u = e.length,
    ...
    ce.event.special[e] = { delegateType: i, bindType: i, handle: function handle(e) {
      ...
      Re = /^\s*<!\[CDATA\[|\]\]>\s*$/g;function Me(e, t) {
    ...
    r = g(r);var e,
      ...
      for (s = (a = ce.map(Se(e, "script"), Ie)).length; c < f; c++) {
        ...
        u = a[c], Ce.test(u.type || "") && !_.access(u, "globalEval") && ce.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? ce._evalUrl && !u.noModule && ce._evalUrl(u.src, { nonce: u.nonce || u.getAttribute("nonce") }, l) : m(u.textContent.replace(Re, ""), u, l));
      }
    }return n;
  }function Be(e, t, n) {
    ...
    return new at.prototype.init(e, t, n, r, i);
      ...
      var i,
          o,
          a,
          s = F(t);return Xe.test(t) || (t = Ze(s)), (a = ce.cssHooks[t] || ce.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ge(e, t, r)), "normal" === i && t in nt && (i = nt[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
    ...
    var n,
      ...
      _t = {},
      Xt = "*/".concat("*"),
      Ut = C.createElement("a");function zt(o) {
    return function (e, t) {
    ...
    }, ajaxPrefilter: zt(Bt), ajaxTransport: zt(_t), ajax: function ajax(e, t) {
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var landingGulpSlider = function landingGulpSlider() {
    $(".dawn-temp-json .dawn-feat-coll-wrap ul").each(function () {
      var slider = $(this);
      var slidesQty = slider.parent().data("slider-slides");
      var slidesToScroll = slider.parent().data("slider-scroll");
      var sliderDots = slider.parent().data("slider-dots") == true ? true : false;
